...
! function () {
  ...
  function b(b) {
    ...
    var c = a("div", "font-family:Helvetica,Arial,sans-serif;font-size:10px;font-weight:bold;padding:5px;text-align:left;opacity:0.8;position:fixed;left:0;top:50%;transform:translateY(-50%);min-width:200px;max-height:50vh;overflow:auto;background:" + b.bgColor + ";color:" + b.color + ";" + b.css);
    return c
  }
