...
! function (a) {
  ...
  var b = function () {
    function b(a, c, d) {
      _classCallCheck(this, b), this.opt = _extends({}, {
        element: "*",
        className: "*",
        filter: [],
        ...
        debug: !1,
        log: window.console
      }, c), this.sv = "string" == typeof d ? [d] : d, this.$ctx = a, this.dct = ["aÀÁÂÃÄÅàáâãäåĀāąĄ", "cÇçćĆčČ", "dđĐďĎ", "eÈÉÊËèéêëěĚĒēęĘ", "iÌÍÎÏìíîïĪī", "lłŁ", "nÑñňŇńŃ", "oÒÓÔÕÕÖØòóôõöøŌō", "rřŘ", "sŠšśŚ", "tťŤ", "uÙÚÛÜùúûüůŮŪū", "yŸÿýÝ", "zŽžżŻźŹ"]
    }
    return _createClass(b, [{
      ...
      value: function (a, b) {
        ...
        return this.opt.iframes || (d = d.concat(["iframe"])), b && (d = d.concat(["*[data-jquery-mark='true']"])), d.every(function (b) {
          return a.is(b) ? c = !1 : !0
        }), !c
      }
    }, {
          ...
          ! function () {
            var d = a.first()[0].contentWindow,
              ...
              g = function () {
                try {
                  var d = a.contents();
                  if (0 === d.length) throw new Error("iframe inaccessible");
                  b(d)
                } catch (a) {
                  c()
                }
                ...
                a.on("load.jqueryMark", function () {
                  try {
                    var b = a.attr("src").trim(),
                      f = d.location.href;
                    f === e && b !== e && "" !== b || (a.off("load.jqueryMark"), g())
                  } catch (a) {
                    c()
                  }
                })
      ...
      value: function (b, c) {
        var d = this,
          e = arguments.length <= 2 || void 0 === arguments[2] ? function () {} : arguments[2],
          f = 0,
          g = function () {
            --f < 1 && e()
          };
        this.onIframeReady(b, function (b) {
          var e = b.find("*");
          f = e.length, 0 === f && g(), e.each(function (b, f) {
            var h = a(f);
      ...
      value: function (b) {
        ...
        0 === h && d(), g.each(function (d, f) {
          var g = a(f);
          if (!c.matchesFilter(g, e)) {
            if (g.is("iframe")) return void c.forEachElementInIframe(g, function (a) {
      ...
      value: function () {
        ...
        "*" !== c && (b += "." + c), this.log('Removal selector "' + b + '"'), this.forEachElement(function (c) {
          ...
          if (d.is(b)) {
            var e = d.parent();
            d.replaceWith(d.html()), e[0].normalize()
          }
        }, this.opt.complete, !1)
      }
    }]), b
